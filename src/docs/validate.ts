...
export const EXPRESS_ROUTE_INVENTORY: Array<{ method: string; path: string }> = [
  ...
  { method: "PATCH", path: "/api/v1/invoices/{id}" },
  { method: "DELETE", path: "/api/v1/invoices/{id}" },
  ...
  { method: "GET", path: "/api/v1/land-parcels" },
  { method: "POST", path: "/api/v1/land-parcels" },
  { method: "GET", path: "/api/v1/land-parcels/{id}" },
  { method: "PATCH", path: "/api/v1/land-parcels/{id}" },
  { method: "DELETE", path: "/api/v1/land-parcels/{id}" },
  { method: "GET", path: "/api/v1/md-notes" },
  { method: "POST", path: "/api/v1/md-notes" },
  { method: "GET", path: "/api/v1/md-notes/{id}" },
  { method: "PATCH", path: "/api/v1/md-notes/{id}" },
  { method: "DELETE", path: "/api/v1/md-notes/{id}" },
